...
namespace PaelystSolution.Infrastructure.Mail
{
    public class MailService : IMailService
    {
        ...
        public void SendEMailAsync(MailRequest mailRequest)
        {
            ...
            string SenderName = "Paelyst Solution";
            string SenderEmail = "yusufadetola07@gmail.com";
            ...
            string ReplyToName = "Paelyst Solution";
            string ReplyToEmail = "yusufadetola07@gmail.com";
            SendSmtpEmailReplyTo ReplyTo = new SendSmtpEmailReplyTo(ReplyToEmail, ReplyToName);
            string stringInBase64 = "aGVsbG8gdGhpcyBpcyB0ZXN0";
            //    string AttachmentUrl = null;
            //  string AttachmentName = mailRequest.AttachmentName;
            ...
            {
                var a = new SendSmtpEmailAttachment
                {
